...
module.exports = {
  ...
  included: function(app) {
    ...
    app.import(app.bowerDirectory + '/material-design-lite-src/src/data-table/data-table.js');
    ...
    app.import(app.bowerDirectory + '/material-design-lite-src/src/menu/menu.js');
